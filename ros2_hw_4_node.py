...
def main()->None:
    ...
    while rclpy.ok():
        ...
        if (time_diff <= time_duration_forward):
            turtlebot_node.move_turtle(forward_speed, 0.0)
        elif(time_diff>time_duration_forward and time_diff<=time_duration_forward+time_duration_turnright):
            turtlebot_node.move_turtle(0.0, turnright_speed)
        elif(time_diff>time_duration_forward+time_duration_turnright and time_diff<time_duration_forward+time_duration_turnright+time_duration_forward):
            turtlebot_node.move_turtle(forward_speed, 0.0)
        else:
